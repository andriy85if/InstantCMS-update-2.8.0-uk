var mySettings = {
	...
	markupSet:  [
		...
		{name:'Відео Facebook', openWith:'<facebook>[![Посилання на ролик Facebook]!]', closeWith:'</facebook>', className: 'btnVideoFacebook'},
        {name:'Код', openWith:'<code type="[![Мова:!:php]!]">', placeHolder:'\n\n', closeWith:'</code>', className: 'btnCode'},
        {name:'Спойлер', openWith:'<spoiler title="[![Назва спойлера:!:Спойлер]!]">', placeHolder:'\n\n', closeWith:'</spoiler>', className: 'btnSpoiler'},
        {name:'Смайли', className: 'btnSmiles', key: 'Z', beforeInsert: function(markItUp) { insertSmiles.displayPanel(markItUp); }}
	]
};
